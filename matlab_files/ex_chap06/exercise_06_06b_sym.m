% exercise_06_06b_sym.m
% 問題 6.6
% I-PD 制御（目標値応答に注目した部分的モデルマッチング法）
% 【Symbolic Math Toolbox】

disp(' ')
disp(' ***** 問題 6.6（目標値応答に注目した I-PD 制御） ********************')
...
% --------------------
disp(' ')
disp(' ---- Gm3(s) を バターワース標準形 (alpha1 = alpha2 = 2, wm = 2) としたときの PID パラメータ ---- ')
kI_butterworth = subs(sol_kI,{alpha1,alpha2,wm},{2,2,2})
kP_butterworth = subs(sol_kP,{alpha1,alpha2,wm},{2,2,2})
kD_butterworth = subs(sol_kD,{alpha1,alpha2,wm},{2,2,2})
