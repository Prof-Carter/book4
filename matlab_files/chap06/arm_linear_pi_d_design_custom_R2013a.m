% arm_linear_pi_d_design_R2013a.m
% 鉛直面を回転するアーム系の PI-D コントローラ設計と線形シミュレーション ====> グラスのカスタマイズ
...
dc = 0.5;
sim('arm_linear_sim_pi_d_cont_R2013a')
% --------------------
...
plot(t,y*(180/pi),t,ym*(180/pi),'--','LineWidth',1.5)
set(gca,'FontSize',14,'FontName','Arial')
xlabel('t [s]','FontSize',16,'FontName','Arial')
ylabel('y(t) and {y}_{m}(t) [deg]','FontSize',16,'FontName','Arial')
legend({'y(t)','{y}_{m}(t) (d(t) = 0)'},'Location','SouthEast','FontSize',16,'FontName','Arial')
ylim([0 (4/3)*rc_deg])
grid on
